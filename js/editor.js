...
document.writeln(''+((typeof(formT)=='undefined' || !formT)?'<u><b id="a_subject"><span style="color:#FF6600">*</span> 标题（名称）：</b></u><br /><input name="subject" id="subject" type="text" value="'+((typeof(subjT)=='undefined' || !subjT)?'':subjT)+'" size="50" maxlength="180" />':formT)+'');
document.writeln(''+((typeof(formF)=='undefined')?'':formF)+'');
document.writeln('<br /><br /><u><b id="a_content"><span style="color:#FF6600">*</span> 内容：</b></u><br />');
...
if(parseFloat(navigator.appVersion)>=4){
  ...
  editor.document.writeln('<html><head><style type="text/css"><!-- body,th,td{font-size:12px;}'+((typeof(formC)=='undefined' || !formC)?'':formC)+' //--></style></head><body></body></html>');
