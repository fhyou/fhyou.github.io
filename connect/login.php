...
<form id="login" action="loginsuccess.php" method="post"> 
    ...
    账号：
    <input id= "username" class="ipt" type="text" name="username" placeholder="请输入用户名">
    </p><br>
    ...
    <div style="height: 50px;line-height: 40px;margin-top: 30px;border-top: 1px solid #e7e7e7;">
    <p style="margin: 0px 35px 20px 45px;">
    <span style="float: left"><a href="register.php" style="color:#ccc;">注册</a></span>
    <span style="float: right">
    <input class="sub" type="submit" value="登陆" name="submit" >
    </span>
    </p>
    </div>
    </div>
